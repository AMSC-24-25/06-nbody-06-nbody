#ifndef BALANCED_QUADTREE_H
#define BALANCED_QUADTREE_H

#include "abstract_quadtree.hpp"

template <typename Vector, std::size_t d>
class BalancedQuadtree : public AbstractQuadtree<Vector, d>
{

protected:
    using Super = AbstractQuadtree<Vector, d>;
...
public:
    ...
    BalancedQuadtree() : AbstractQuadtree<Vector, d>() {}
    virtual ~BalancedQuadtree() = 0;
};
...
template <typename Vector, std::size_t d>
std::array<uint32_t, d> BalancedQuadtree<Vector, d>::
...
template <typename Vector, std::size_t d>
uint32_t BalancedQuadtree<Vector, d>::
...
template <typename Vector, std::size_t d>
BalancedQuadtree<Vector, d>::~BalancedQuadtree() {}
