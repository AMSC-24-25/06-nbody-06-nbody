...
public:
    ...
    AbstractQuadtree() : child_center_directions(getChildCenterDirections()) {};
    ...
    virtual ~AbstractQuadtree() = 0;
};

template <typename Vector, std::size_t d>
struct AbstractQuadtree<Vector, d>::BaseNode
{
...
template <typename Vector, std::size_t d>
bool AbstractQuadtree<Vector, d>::BaseNode::adjacent(BaseNode *other) const
{
...
template <typename Vector, std::size_t d>
bool AbstractQuadtree<Vector, d>::BaseNode::contains(const Vector &point) const
{
...
template <typename Vector, std::size_t d>
template <typename Node>
void AbstractQuadtree<Vector, d>::traverseBFSCore(const std::function<void(Node *)> &processNode)
{
...
template <typename Vector, std::size_t d>
std::array<Vector, AbstractQuadtree<Vector, d>::n_children>
AbstractQuadtree<Vector, d>::getChildCenterDirections()
{
    ...
    for (std::size_t i = 0; i < AbstractQuadtree<Vector, d>::n_children; ++i)
    {
...
// (x, y, ...)
template <typename Vector, std::size_t d>
std::tuple<Vector, Vector> AbstractQuadtree<Vector, d>::getDataRange(
...
template <typename Vector, std::size_t d>
AbstractQuadtree<Vector, d>::~AbstractQuadtree() {}
